...
def article_titles(request, username=None):
    ...
    if username:
        return render(request, "article/list/author_articles.html", {"articles": articles, "page": current_page, "userdata": userdata, "user": user})
...
def article_detail(request, id, slug):
    ...
    article_ranking = r.zrange('article_ranking', 0, -1, desc=True)[:6]
