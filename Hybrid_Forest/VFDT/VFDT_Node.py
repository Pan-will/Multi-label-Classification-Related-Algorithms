...
class VfdtNode:
    def __init__(self, possible_split_features):
        """
        nijk: statistics of feature i, value j, class；特征i，j值，类的统计
        :list possible_split_features: features；可能拆分的特征，list类型
        """
        self.parent = None
        self.left_child = None
        self.right_child = None
        self.split_feature = None
        self.split_value = None  # both continuous and discrete value；连续值和离散值
