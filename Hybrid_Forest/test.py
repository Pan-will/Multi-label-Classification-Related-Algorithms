...
if plot:
    ...
    for jidx in range(j):
        ...
        plt.savefig(
            figsave_directory + dataset_fig_dir + "/stackedbars_hyi-{}.svg".format(hybrid_power_threshold_array[jidx]),
            format='svg')
        plt.savefig(
            figsave_directory + dataset_fig_dir + "/stackedbars_hyi-{}.png".format(hybrid_power_threshold_array[jidx]),
            format='png')
    ...
    for iidx in range(i):
        ...
        plt.ylabel('Accuracy')
        plt.legend((p1[0], p2[0]), ('VFDT', 'Hybrid'))
        plt.savefig(figsave_directory + dataset_fig_dir + "/stackedbars_wsz-{}.svg".format(windows_size_array[iidx]),
                    format='svg')
        plt.savefig(figsave_directory + dataset_fig_dir + "/stackedbars_wsz-{}.png".format(windows_size_array[iidx]),
                    format='png')
    ...
    for iidx in range(i):
        ...
        plt.tight_layout()
        plt.savefig(figsave_directory + dataset_fig_dir + "/comparison_wsz-{}.svg".format(windows_size_array[iidx]),
                    format='svg')
        plt.savefig(figsave_directory + dataset_fig_dir + "/comparison_wsz-{}.png".format(windows_size_array[iidx]),
                    format='png')
    ...
    for jidx in range(j):
        ...
        plt.tight_layout()
        plt.savefig(
            figsave_directory + dataset_fig_dir + "/comparison_hyi-{}.svg".format(hybrid_power_threshold_array[jidx]),
            format='svg')
        plt.savefig(
            figsave_directory + dataset_fig_dir + "/comparison_hyi-{}.png".format(hybrid_power_threshold_array[jidx]),
            format='png')

    plt.show()

# size=100, Threshold = 0.2时效果最好。
# Hybrid: % 76.25500000000001
# VFDT: % 72.5
# Random Forest: % 72.67
